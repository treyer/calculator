describe('Easy calculations in simple expression mode', () => {
  afterEach(() => {
    ...
    cy.checkCalculationResultClass('0')
  })
  ...
  it('Test simple addition', () => {
    ...
    cy.checkCalculationResultClass('4')
  })
...
describe('Medium calculations in complex expression mode', () => {
  ...
  it('Brackets test 1', () => {
    ...
    cy.checkCalculationResultClass('-821.556')
  })
  ...
  it('Brackets test 2', () => {
    ...
    cy.checkCalculationResultClass('431461.24')
  })
  ...
  it('Brackets test 3', () => {
    ...
    cy.checkCalculationResultClass('98.671')
  })

  it('Brackets test 4', () => {
    cy.enterBasicKeypadExpression('(97/48+86+56*94)/43+57=')
    cy.checkCalculationResultClass('181.466')
  })

  it('Brackets test 5', () => {
    cy.enterBasicKeypadExpression('(68-85/75*64)/15+73=')
    cy.checkCalculationResultClass('72.698')
  })

  it('Brackets test 6', () => {
    cy.enterBasicKeypadExpression('91+18/(42+62+84*95)+30=')
    cy.checkCalculationResultClass('121.002')
  })
  ...
  it('Brackets test 7', () => {
    ...
    cy.checkCalculationResultClass('428.211')
  })
  ...
  it('Brackets test 8', () => {
    ...
    cy.checkCalculationResultClass('167.291')
  })
  ...
  it('Brackets test 9', () => {
    ...
    cy.checkCalculationResultClass('81.246')
  })
  ...
  it('Brackets test 10', () => {
    ...
    cy.checkCalculationResultClass('25.898')
  })
  ...
  it('Brackets test 11', () => {
    ...
    cy.checkCalculationResultClass('-15.648')
  })

  it('Brackets test 12', () => {
    cy.enterBasicKeypadExpression('(41*76*79-61)/60+83=')
    cy.checkCalculationResultClass('4184.717')
  })

  it('Brackets test 13', () => {
    cy.enterBasicKeypadExpression('(73+85+64/17)*17+31/60=')
    cy.checkCalculationResultClass('2750.517')
  })
  ...
  it('Brackets test 14', () => {
    ...
    cy.checkCalculationResultClass('7104.237')
  })

  it('Brackets test 15', () => {
    cy.enterBasicKeypadExpression('33-96+(95-76*98/11)*15=')
    cy.checkCalculationResultClass('-8794.364')
  })
  ...
  it('Brackets test 16', () => {
    ...
    cy.checkCalculationResultClass('3.711')
  })
  ...
  it('Brackets test 17', () => {
    ...
    cy.checkCalculationResultClass('6872')
  })

  it('Brackets test 18', () => {
    cy.enterBasicKeypadExpression('85*97/(89/11-18*96)-61=')
    cy.checkCalculationResultClass('-65.794')
  })
  ...
  it('Brackets test 19', () => {
    ...
    cy.checkCalculationResultClass('-89367.736')
  })

  it('Brackets test 20', () => {
    cy.enterBasicKeypadExpression('52*62*(61+12-14*79)+39=')
    cy.checkCalculationResultClass('-3330353')
  })
  ...
  it('Brackets test 21', () => {
    ...
    cy.checkCalculationResultClass('-13')
  })
  ...
  it('Brackets test 22', () => {
    ...
    cy.checkCalculationResultClass('22')
  })
...
describe('Hard calculations in complex expression mode', () => {
  ...
  it('Nested brackets test 1', () => {
    ...
    cy.checkCalculationResultClass('-10.023')
  })
  ...
  it('Nested brackets test 2', () => {
    ...
    cy.checkCalculationResultClass('-20871.247')
  })
  ...
  it('Nested brackets test 3', () => {
    ...
    cy.checkCalculationResultClass('-3703376512014.667')
  })
  ...
  it('Nested brackets test 4', () => {
    ...
    cy.checkCalculationResultClass('94013.707')
  })
  ...
  it('Nested brackets test 5', () => {
    ...
    cy.checkCalculationResultClass('-3107.053')
  })
  ...
  it('Nested brackets test 6', () => {
    ...
    cy.checkCalculationResultClass('-88.551')
  })
  ...
  it('Nested brackets test 7', () => {
    ...
    cy.checkCalculationResultClass('-767.073')
  })
  ...
  it('Nested brackets test 8', () => {
    ...
    cy.checkCalculationResultClass('3983.39')
  })
  ...
  it('Nested brackets test 9', () => {
    ...
    cy.checkCalculationResultClass('84.001')
  })
  ...
  it('Nested brackets test 10', () => {
    ...
    cy.checkCalculationResultClass('43698.2')
  })
  ...
  it('Nested brackets test 11', () => {
    ...
    cy.checkCalculationResultClass('-81.052')
  })
  ...
  it('Nested brackets test 12', () => {
    ...
    cy.checkCalculationResultClass('136201.64')
  })
  ...
  it('Nested brackets test 13', () => {
    ...
    cy.checkCalculationResultClass('81.973')
  })
  ...
  it('Nested brackets test 14', () => {
    ...
    cy.checkCalculationResultClass('-11.829')
  })
  ...
  it('Nested brackets test 15', () => {
    ...
    cy.checkCalculationResultClass('-331754184')
  })
  ...
  it('Nested brackets test 16', () => {
    ...
    cy.checkCalculationResultClass('59.295')
  })
  ...
  it('Nested brackets test 17', () => {
    ...
    cy.checkCalculationResultClass('65.053')
  })
  ...
  it('Nested brackets test 18', () => {
    ...
    cy.checkCalculationResultClass('603787.745')
  })
  ...
  it('Nested brackets test 19', () => {
    ...
    cy.checkCalculationResultClass('1.254')
  })
  ...
  it('Nested brackets test 20', () => {
    ...
    cy.checkCalculationResultClass('23.982')
  })
  ...
  it('Nested brackets test 21', () => {
    ...
    cy.checkCalculationResultClass('73.003')
  })
  ...
  it('Nested brackets test 22', () => {
    ...
    cy.checkCalculationResultClass('4930.52')
  })
  ...
  it('Nested brackets test 23', () => {
    ...
    cy.checkCalculationResultClass('12313.572')
  })
  ...
  it('Nested brackets test 24', () => {
    ...
    cy.checkCalculationResultClass('-994.428')
  })
  ...
  it('Nested brackets test 25', () => {
    ...
    cy.checkCalculationResultClass('-15710078.059')
  })
  ...
  it('Nested brackets test 26', () => {
    ...
    cy.checkCalculationResultClass('6420.001')
  })
  ...
  it('Nested brackets test 27', () => {
    ...
    cy.checkCalculationResultClass('11.857')
  })
  ...
  it('Nested brackets test 29', () => {
    ...
    cy.checkCalculationResultClass('48.376')
  })
  ...
  it('Nested brackets test 30', () => {
    ...
    cy.checkCalculationResultClass('72.685')
  })
  ...
  it('Nested brackets test 31', () => {
    ...
    cy.checkCalculationResultClass('72.852')
  })
  ...
  it('Nested brackets test 32', () => {
    ...
    cy.checkCalculationResultClass('60.941')
  })
})
